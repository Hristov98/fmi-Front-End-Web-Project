...
xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
        ...
        for (let i = 0; i < jsonResultArray.length; i++) {
            if (jsonResultArray[i].type === "Mammal") {
...
document.getElementById("mammalsButton").style.color = "white";
document.getElementById("mammalsButton").style.backgroundColor = "#2c328bbe";
document.getElementById("mammalsButton").style.border = "0.1rem solid white";