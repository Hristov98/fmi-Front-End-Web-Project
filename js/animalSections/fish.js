...
xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
        ...
        for (let i = 0; i < jsonResultArray.length; i++) {
            if (jsonResultArray[i].type === "Ocean Fish") {
...
document.getElementById("fishButton").style.color = "white";
document.getElementById("fishButton").style.backgroundColor = "#2c328bbe";
document.getElementById("fishButton").style.border = "0.1rem solid white";