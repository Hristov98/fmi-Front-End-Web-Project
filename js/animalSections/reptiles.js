...
xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
        ...
        for (let i = 0; i < jsonResultArray.length; i++) {
            if (jsonResultArray[i].type === "Reptile") {
...
document.getElementById("reptilesButton").style.color = "white";
document.getElementById("reptilesButton").style.backgroundColor = "#2c328bbe";
document.getElementById("reptilesButton").style.border = "0.1rem solid white";
