...
xhttp.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
        ...
        for (let i = 0; i < jsonResultArray.length; i++) {
            if (jsonResultArray[i].type === "Shark") {
...
document.getElementById("sharksButton").style.color = "white";
document.getElementById("sharksButton").style.backgroundColor = "#2c328bbe";
document.getElementById("sharksButton").style.border = "0.1rem solid white";